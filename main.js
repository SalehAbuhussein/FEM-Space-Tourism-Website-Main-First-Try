$(function () {
  ...
  let destinationPlanetDescription = $(
    '.destination__planet-content-description'
  );
  ...
  $('.dots a').on('click', (event) => {
    ...
    let {
      ...
      role,
      bio,
    } = crewData[activeDestinationIndex];
  ...
  $('.slider a').on('click', (event) => {
    ...
    let {
      ...
      description,
    } = technologyData[technologyActiveIndex];
